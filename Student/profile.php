                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="m-t-30"> <img src="assets/images/users/<?php echo $_SESSION["img"];
                                      ?> " class="rounded-circle" width="150" />
                                    <h4 class="card-title m-t-10"><?php echo $_SESSION["stname"]; ?> </h4>
                                    <h6 class="card-subtitle">Web Designer &amp; Developer</h6>
                                    <a href="#" style="color: white"
                                    class="m-t-10 waves-effect waves-dark btn btn-primary btn-md btn-rounded"><?php echo $_SESSION["stroll"]; ?></a>
