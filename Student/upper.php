                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand ml-4" href="index.html">
                        ...
                        <b class="logo-icon" >
                            ...
                            <!-- Dark Logo icon -->
<!--  -->                            <img src="assets/images/iiitdmj.png" width="70" alt="homepage" class="dark-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <!-- ============================================================== -->
                          <div id ="x" style="color: black ; padding-top: 20px; padding-right: 450px"><h1 style="text-decoration: underline;">Student Panel</h1> </div>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
//                      src="assets/images/users/<?php echo $_SESSION["img"]; ?>" alt="user" class="profile-pic m-r-10">
                       <?php echo $_SESSION["stname"]; ?></a>
                        </li>
                    </ul>
                </div>
            </nav>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="https://www.iiitdmj.ac.in/" aria-expanded="false"><i class="mdi mr-2 mdi-gauge"></i><span class="hide-menu">Go To Site</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="profile.php" aria-expanded="false">
                                <i class="mdi mr-2 mdi-account-check"></i><span class="hide-menu">Profile</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="view_profile.php" aria-expanded="false"><i class="mdi mr-2 mdi-help-circle"></i><span
                                    class="hide-menu">View Others Profile</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="attendance.php" aria-expanded="false"><i class="mdi mr-2 mdi-table"></i><span
                                    class="hide-menu">Attendance</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="marks.php" aria-expanded="false"><i
                                    class="mdi mr-2 mdi-emoticon"></i><span class="hide-menu">Marks</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="fees.php" aria-expanded="false"><i class="mdi mr-2 mdi-earth"></i><span
                                    class="hide-menu">Fees</span></a></li>
